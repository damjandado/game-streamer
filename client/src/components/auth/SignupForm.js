...
class SignupForm extends Component {
        ...
        return formFields.map(({ name, type, placeholder, icon }) => {
            return [
                <div className="form-group row">
                    <label for={name} className="col-sm-3 col-form-label pl-4 pr-0 text-left">
                        {placeholder}
                    </label>
    ...
    render() {
        return (
            <div className="signin-form profile col-lg-7 gs-center" style={{ marginTop: '5%' }}>
                ...
                <p className="text-right pr-0 col-sm-10">
                    <small style={{ marginTop: '12px' }}> Click next for the final step</small>
                </p>
            </div>
        );
    }
